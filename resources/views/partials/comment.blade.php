<div class="card mb-3 ml-4">
    <div class="card-body">
        ...
        Total likes: <button data-bs-target="#commentLikesModal" data-bs-toggle="modal" class="commentLikes" data-comment-id="{{ $comment->id }}">{{ $comment->likes_comment_count  }}</button>
